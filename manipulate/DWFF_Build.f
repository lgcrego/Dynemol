...
! atomic pairs
if(.not. allocated(HOH_diss_parms% PairSymbols))  allocate( HOH_diss_parms% PairSymbols(3,2) )
...
if(.not. allocated(HOH_diss_parms% SR))  allocate( HOH_diss_parms% SR(2,3) )
...
if(.not. allocated(HOH_diss_parms% Coul))  allocate( HOH_diss_parms% Coul(3,4) )
...
if(.not. allocated(HOH_diss_parms% Angle))  allocate( HOH_diss_parms% Angle(1,4) )
